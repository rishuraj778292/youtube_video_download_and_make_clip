...
// const makeSingleClip = async (req, res) => {
//     const { driveUrl, customText, startTime, endTime, username, designation } = req.body;
...
// [bg][vid]overlay=(W-w)/2:(H-h)/2[video_on_bg]; \
// [video_on_bg][1:v]overlay=(W-w)/2:60[with_logo]; \
// [with_logo]drawtext=text='${escapeText(line1)}':fontcolor=white:fontsize=42:x=(w-text_w)/2:y=200:box=1:boxcolor=black@0.5:boxborderw=10[line1]; \
// [line1]drawtext=text='${escapeText(line2)}':fontcolor=white:fontsize=42:x=(w-text_w)/2:y=250:box=1:boxcolor=black@0.5:boxborderw=10[line2]; \
// [line2]drawtext=text='${escapeText(line3)}':fontcolor=white:fontsize=42:x=(w-text_w)/2:y=300:box=1:boxcolor=black@0.5:boxborderw=10[line3]; \
// [line3]drawtext=text='${usernameText}':fontcolor=white:fontsize=35:x=(w-text_w)/2:y=(h-300):box=1:boxcolor=black@0.5:boxborderw=10[username]; \
// [username]drawtext=text='${designationText}':fontcolor=#0098A8:fontsize=42:x=(w-text_w)/2:y=(h-250)+10:box=1:boxcolor=black@0.5:boxborderw=10[outv]\
// " -map "[outv]" -map 0:a? -y "${outputClipPath}"`;
...
//     // Use system serif font instead of external font file
//     const ffmpegCmd = `ffmpeg -ss ${startTime} -t ${duration} -i "${rawVideoPath}" -i "${logoPath}" -filter_complex "\
// [0:v]scale=720:-1[vid]; \
// color=color=black:size=720x1280:d=${duration}[bg]; \
// [bg][vid]overlay=(W-w)/2:(H-h)/2[video_on_bg]; \
// [video_on_bg][1:v]overlay=(W-w)/2:60[with_logo]; \
// [with_logo]drawtext=text='${escapeText(line1)}':font=serif:fontcolor=white:fontsize=42:x=(w-text_w)/2:y=200:box=1:boxcolor=black@0.5:boxborderw=10[line1]; \
// [line1]drawtext=text='${escapeText(line2)}':font=serif:fontcolor=white:fontsize=42:x=(w-text_w)/2:y=250:box=1:boxcolor=black@0.5:boxborderw=10[line2]; \
// [line2]drawtext=text='${escapeText(line3)}':font=serif:fontcolor=white:fontsize=42:x=(w-text_w)/2:y=300:box=1:boxcolor=black@0.5:boxborderw=10[line3]; \
// [line3]drawtext=text='${usernameText}':font=serif:fontcolor=white:fontsize=35:x=(w-text_w)/2:y=(h-300):box=1:boxcolor=black@0.5:boxborderw=10[username]; \
// [username]drawtext=text='${designationText}':font=serif:fontcolor=#0098A8:fontsize=42:x=(w-text_w)/2:y=(h-250)+10:box=1:boxcolor=black@0.5:boxborderw=10[outv]\
// " -map "[outv]" -map 0:a? -y "${outputClipPath}"`;
...
[bg][vid]overlay=(W-w)/2:(H-h)/2[video_on_bg]; \
[video_on_bg][1:v]overlay=(W-w)/2:60[with_logo]; \
[with_logo]drawtext=text='${escapeText(line1)}':font='${boldFont}':fontcolor=white:fontsize=${line1FontSize}:x=(w-text_w)/2:y=200:box=1:boxcolor=black@0.5:boxborderw=10[line1]; \
[line1]drawtext=text='${escapeText(line2)}':font='${boldFont}':fontcolor=white:fontsize=${line2FontSize}:x=(w-text_w)/2:y=250:box=1:boxcolor=black@0.5:boxborderw=10[line2]; \
[line2]drawtext=text='${escapeText(line3)}':font='${boldFont}':fontcolor=white:fontsize=${line3FontSize}:x=(w-text_w)/2:y=300:box=1:boxcolor=black@0.5:boxborderw=10[line3]; \
[line3]drawtext=text='${usernameText}':font='${boldFont}':fontcolor=white:fontsize=${usernameFontSize}:x=(w-text_w)/2:y=(h-300):box=1:boxcolor=black@0.5:boxborderw=10[username]; \
[username]drawtext=text='${designationText}':font='${boldFont}':fontcolor=#0098A8:fontsize=${designationFontSize}:x=(w-text_w)/2:y=(h-250)+10:box=1:boxcolor=black@0.5:boxborderw=10[outv]\
" -map "[outv]" -map 0:a? -y "${outputClipPath}"`;
